...
<section class="reviews">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <p>Our business ia about Technology, Yes. But It's also about coustomer relationships.</p>
         <div class="stars">
      ...
      <div class="swiper-slide slide">
         ...
         <h3>Anand Raj Dubey</h3>
      </div>

      <div class="swiper-slide slide">
         <img src="images/choote.jpg" alt="">
         <p>Business aren't B2B or B2C they're Human to Human (H2H)</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
         ...
         <h3>Chhot Lal Bairwa</h3>
      </div>

      <div class="swiper-slide slide">
         <img src="images/aashish.jpg" alt="">
         <p>Ideas are commodity execution is not!</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
